...
def problem_four(request):
   students_count = Student.objects.filter(id__gt=0).count()
   courses_count = Course.objects.filter(id__gt=0).count()
   instructors_count = Instructor.objects.filter(id__gt=0).count()
...
def problem_five(request):
    ...
    new_student = Student.objects.create(first_name = 'Chris',last_name = 'Campbell',year = '2022', gpa = '3.2')
